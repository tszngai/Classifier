...
\begin{table}
 ...
 Random Forest &\begin{tabular}{llll}
  ...
  \begin{tabular}{ll}
    ...
    \midrule
    Random Forest &\begin{tabular}{llll}
      \begin{tabular}{lll} 73.9&88.1&85.3\end{tabular}&
      \begin{tabular}{lll} 71.1&88.5&84.9 \end{tabular}
    \end{tabular}\\
    
    KNN &\begin{tabular}{llll}
      \begin{tabular}{lll} N/A&N/A&N/A\end{tabular}&
      \begin{tabular}{lll} 63.0&81.1&79.1 \end{tabular}
    \end{tabular}\\
    
    Decision Tree &\begin{tabular}{llll}
      \begin{tabular}{lll}45.3&93.8&71.6 \end{tabular}&
      \begin{tabular}{lll}77.3&88.0&86.1\end{tabular}
    \end{tabular}\\
    
    Logistic regression &\begin{tabular}{llll}
      \begin{tabular}{lll} 72.9&88.2&85.3 \end{tabular}&
    ...
    SVM &\begin{tabular}{llll}
      ...
      \begin{tabular}{lll} 77.6&80.6&80.4 \end{tabular}
    \end{tabular}\\
...
The second experiment explores how ensemble method can affect the model performance. From the result of Section~\ref{balancing_experiment}, we determine that Over Sampling performs better in most of the algorithms in this binary data set. Therefore Over Sampling is used in both groups of this experiment in order to control experimental factors. Similar to the previous part, models are compared in three different matrices SEN, SPE and PA.
